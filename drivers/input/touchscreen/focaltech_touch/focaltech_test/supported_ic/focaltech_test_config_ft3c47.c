...
*
* File Name: Focaltech_test_config_ft3c47.c
*
...
void SetTestItem_FT3C47(void)
{
	...
	if (g_stCfg_FT3C47_TestItem.RESET_PIN_TEST == 1) {
		...
		fts_SetTestItemCodeName(Code_FT3C47_RESET_PIN_TEST);
	}

	//////////////////////////////////////////////////FACTORY_ID_TEST
	if (g_stCfg_FT3C47_TestItem.FACTORY_ID_TEST == 1) {
		fts_SetTestItemCodeName(Code_FT3C47_FACTORY_ID_TEST);
	}

	//////////////////////////////////////////////////Project Code Test
	if (g_stCfg_FT3C47_TestItem.PROJECT_CODE_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_PROJECT_CODE_TEST);
	}
	...
	if (g_stCfg_FT3C47_TestItem.LCM_ID_TEST == 1) {
		...
		fts_SetTestItemCodeName(Code_FT3C47_LCM_ID_TEST);
	}

	//////////////////////////////////////////////////IC Version Test
	if (g_stCfg_FT3C47_TestItem.IC_VERSION_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_IC_VERSION_TEST);
	}

	//////////////////////////////////////////////////Enter Factory Mode
	fts_SetTestItemCodeName(Code_FT3C47_ENTER_FACTORY_MODE);

	//////////////////////////////////////////////////TE_TEST
	if (g_stCfg_FT3C47_TestItem.TE_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_TE_TEST);
	}

	//////////////////////////////////////////////////CHANNEL_NUM_TEST
	if (g_stCfg_FT3C47_TestItem.CHANNEL_NUM_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_CHANNEL_NUM_TEST);
	}

	//////////////////////////////////////////////////NOISE_TEST
	if (g_stCfg_FT3C47_TestItem.NOISE_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_NOISE_TEST);
	}

	//////////////////////////////////////////////////RawData Test
	if (g_stCfg_FT3C47_TestItem.RAWDATA_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_RAWDATA_TEST);
	}

	//////////////////////////////////////////////////Rawdata Uniformity Test
	if (g_stCfg_FT3C47_TestItem.UNIFORMITY_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_UNIFORMITY_TEST);
	}

	//////////////////////////////////////////////////SITO_Rawdata Uniformity Test
	if (g_stCfg_FT3C47_TestItem.SITO_RAWDATA_UNIFORMITY_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_SITO_RAWDATA_UNIFORMITY_TEST);
	}

	//////////////////////////////////////////////////CM Test
	if (g_stCfg_FT3C47_TestItem.CM_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_CM_TEST);
	}

	//////////////////////////////////////////////////Adc Detect Test
	if (g_stCfg_FT3C47_TestItem.ADC_DETECT_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_ADCDETECT_TEST);
	}

	//////////////////////////////////////////////////SCAP_CB_TEST
	if (g_stCfg_FT3C47_TestItem.SCAP_CB_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_SCAP_CB_TEST);
	}

	//////////////////////////////////////////////////SCAP_RAWDATA_TEST
	if (g_stCfg_FT3C47_TestItem.SCAP_RAWDATA_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_SCAP_RAWDATA_TEST);
	}

	//////////////////////////////////////////////////RAWDATA_MARGIN_TEST
	if (g_stCfg_FT3C47_TestItem.RAWDATA_MARGIN_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_RAWDATA_MARGIN_TEST);
	}

	//////////////////////////////////////////////////WEAK_SHORT_CIRCUIT_TEST
	if (g_stCfg_FT3C47_TestItem.WEAK_SHORT_CIRCUIT_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_WEAK_SHORT_CIRCUIT_TEST);
	}

	//////////////////////////////////////////////////panel differ_TEST
	if (g_stCfg_FT3C47_TestItem.PANEL_DIFFER_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_PANELDIFFER_TEST);
	}
	//////////////////////////////////////////////////panel differ uniformity
	if (g_stCfg_FT3C47_TestItem.PANEL_DIFFER_UNIFORMITY_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_PANELDIFFER_UNIFORMITY_TEST);
	}

	//////////////////////////////////////////////////INT_PIN_TEST
	if (g_stCfg_FT3C47_TestItem.INT_PIN_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_INT_PIN_TEST);
	}
	...
	if (g_stCfg_FT3C47_TestItem.FORCETOUCH_CHANNEL_NUM_TEST == 1) {
		...
		fts_SetTestItemCodeName(Code_FT3C47_FORCE_TOUCH_CHANNEL_NUM_TEST);
	}

	//////////////////////////////////////////////////FORCETOUCH_RAWDATA_TEST
	if (g_stCfg_FT3C47_TestItem.FORCETOUCH_RAWDATA_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_FORCE_TOUCH_SCAP_RAWDATA_TEST);
	}

	//////////////////////////////////////////////////FORCETOUCH_FLATNESS_TEST
	if (g_stCfg_FT3C47_TestItem.FORCETOUCH_FLATNESS_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_FORCE_TOUCH_FLATNESS_TEST);
	}

	//////////////////////////////////////////////////FORCETOUCH_CB_TEST
	if (g_stCfg_FT3C47_TestItem.FORCETOUCH_CB_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_FORCE_TOUCH_SCAP_CB_TEST);
	}

	//////////////////////////////////////////////////FORCETOUCH_WEAK_SHORT_CIRCUIT_TEST
	if (g_stCfg_FT3C47_TestItem.FORCETOUCH_WEAK_SHORT_CIRCUIT_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT3C47_FORCE_TOUCH_WEAK_SHORT_CIRCUIT_TEST);
	}
