...
*
* File Name: Focaltech_test_config_ft8736.c
*
...
void OnInit_FT8736_TestItem(char *strIniFile)
{
	...
	//////////////////////////////////////////////////////////// IC Type
	GetPrivateProfileString("TestItem", "ICTYPE_TEST", "0", str, strIniFile);
	g_stCfg_FT8736_TestItem.ICTYPE_TEST = fts_atoi(str);
	...
	g_stCfg_FT8736_TestItem.SHORT_CIRCUIT_TEST = fts_atoi(str);
	...
	g_stCfg_FT8736_TestItem.LCD_NOISE_TEST = fts_atoi(str);

	/////////////////////////////////// CB_DECREASE_TEST
	GetPrivateProfileString("TestItem", "CB_DECREASE_TEST", "0", str, strIniFile);
	g_stCfg_FT8736_TestItem.CB_DECREASE_TEST = fts_atoi(str);

	/////////////////////////////////// VREF_DECREASE_TEST
	GetPrivateProfileString("TestItem", "VREF_DECREASE_TEST", "0", str, strIniFile);
	g_stCfg_FT8736_TestItem.VREF_DECREASE_TEST = fts_atoi(str);
...
void OnInit_FT8736_BasicThreshold(char *strIniFile)
{
	...
	g_stCfg_FT8736_BasicThreshold.bRawDataTest_VA_Check = fts_atoi(str);
	...
	g_stCfg_FT8736_BasicThreshold.bRawDataTest_VKey_Check = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "RawDataTest_Min_VKey", "5000", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.RawDataTest_Min_VKey = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "RawDataTest_Max_VKey", "11000", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.RawDataTest_Max_VKey = fts_atoi(str);
	...
	g_stCfg_FT8736_BasicThreshold.LCDNoiseTest_FrameNum = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "LCDNoiseTest_Coefficient", "60", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.LCDNoiseTest_Coefficient = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "LCDNoiseTest_NoiseMode", "0", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.LCDNoiseTest_NoiseMode = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "LCDNoiseTest_Coefficient_Key", "60", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.LCDNoiseTest_Coefficient_Key = fts_atoi(str);

	////////////////////////////////////////////////////////////CBDecreaseTest
	GetPrivateProfileString("Basic_Threshold", "CBDecrease_Step", "4", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.CBDecrease_Step = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "CBDecrease_OrgMin", "4", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.CBDecrease_OrgMin = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "CBDecrease_OrgMax", "400", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.CBDecrease_OrgMax = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "CBDecrease_CalcMin", "4", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.CBDecrease_CalcMin = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "CBDecrease_CalcMax", "4", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.CBDecrease_CalcMax = fts_atoi(str);

	////////////////////////////////////////////////////////////VRefDecreaseTest
	GetPrivateProfileString("Basic_Threshold", "VRefDecrease_Step_Begin", "4", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.VRefDecrease_StepBegin = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "VRefDecrease_Step_End", "4", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.VRefDecrease_StepEnd = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "VRefDecrease_OrgMin", "4", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.VRefDecrease_OrgMin = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "VRefDecrease_OrgMax", "400", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.VRefDecrease_OrgMax = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "VRefDecrease_CalcMin", "4", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.VRefDecrease_CalcMin = fts_atoi(str);
	GetPrivateProfileString("Basic_Threshold", "VRefDecrease_CalcMax", "400", str, strIniFile);
	g_stCfg_FT8736_BasicThreshold.VRefDecrease_CalcMax = fts_atoi(str);
...
void SetTestItem_FT8736(void)
{
	...
	if (g_stCfg_FT8736_TestItem.FACTORY_ID_TEST == 1) {
		...
		fts_SetTestItemCodeName(Code_FT8736_FACTORY_ID_TEST);
	}

	//////////////////////////////////////////////////Project Code Test
	if (g_stCfg_FT8736_TestItem.PROJECT_CODE_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_PROJECT_CODE_TEST);
	}

	//////////////////////////////////////////////////FW Version Test
	if (g_stCfg_FT8736_TestItem.FW_VERSION_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_FW_VERSION_TEST);
	}

	//////////////////////////////////////////////////IC Version Test
	if (g_stCfg_FT8736_TestItem.IC_VERSION_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_IC_VERSION_TEST);
	}

	//////////////////////////////////////////////////Enter Factory Mode
	fts_SetTestItemCodeName(Code_FT8736_ENTER_FACTORY_MODE);

	//////////////////////////////////////////////////Short Test
	if (g_stCfg_FT8736_TestItem.SHORT_CIRCUIT_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_SHORT_CIRCUIT_TEST);
	}

	//////////////////////////////////////////////////CHANNEL_NUM_TEST
	if (g_stCfg_FT8736_TestItem.CHANNEL_NUM_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_CHANNEL_NUM_TEST);
	}

	//////////////////////////////////////////////////CB_TEST
	if (g_stCfg_FT8736_TestItem.CB_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_CB_TEST);
	}

	//////////////////////////////////////////////////CB_UNIFORMITY_TEST
	if (g_stCfg_FT8736_TestItem.CB_UNIFORMITY_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_CB_UNIFORMITY_TEST);
	}

	//////////////////////////////////////////////////NOISE_TEST
	if (g_stCfg_FT8736_TestItem.NOISE_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_NOISE_TEST);
	}

	//////////////////////////////////////////////////LCD_NOISE_TEST
	if (g_stCfg_FT8736_TestItem.LCD_NOISE_TEST == 1) {
		fts_SetTestItemCodeName(Code_FT8736_LCD_NOISE_TEST);
	}
	...
	if (g_stCfg_FT8736_TestItem.RAWDATA_TEST == 1) {
		...
		fts_SetTestItemCodeName(Code_FT8736_RAWDATA_TEST);
	}

	//////////////////////////////////////////////////DIFFER_UNIFORMITY_TEST
	if (g_stCfg_FT8736_TestItem.DIFFER_UNIFORMITY_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_DIFFER_UNIFORMITY_TEST);
	}
	...
	if (g_stCfg_FT8736_TestItem.OPEN_TEST == 1) {
		...
		fts_SetTestItemCodeName(Code_FT8736_OPEN_TEST);
	}

	//////////////////////////////////////////////////CB_DECREASE_TEST
	if (g_stCfg_FT8736_TestItem.CB_DECREASE_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_CB_DECREASE_TEST);
	}

	//////////////////////////////////////////////////VREF_DECREASE_TEST
	if (g_stCfg_FT8736_TestItem.VREF_DECREASE_TEST == 1) {

		fts_SetTestItemCodeName(Code_FT8736_VREF_DECREASE_TEST);
	}
	...
	if (g_stCfg_FT8736_TestItem.DIFFER2_UNIFORMITY_TEST == 1) {
		...
		fts_SetTestItemCodeName(Code_FT8736_DIFFER2_UNIFORMITY_TEST);
	}
