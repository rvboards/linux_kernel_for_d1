...
int malloc_struct_DetailThreshold(void)
{
	...
	if (g_stCfg_Incell_DetailThreshold.InvalidNode == NULL) {
	...
	if (g_stCfg_Incell_DetailThreshold.CBUniformityTest_CHY_Linearity == NULL) {
	...
	if (g_stCfg_Incell_DetailThreshold.CBUniformityTest_CHX_Linearity == NULL) {
