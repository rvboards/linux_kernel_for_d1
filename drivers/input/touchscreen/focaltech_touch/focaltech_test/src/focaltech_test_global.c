...
char *g_pTmpBuff;
char *g_pStoreMsgArea;
int g_lenStoreMsgArea;
char *g_pMsgAreaLine2;
int g_lenMsgAreaLine2;
char *g_pStoreDataArea;
int g_lenStoreDataArea;
unsigned char m_ucTestItemCode;
int m_iStartLine;
int m_iTestDataCount;
